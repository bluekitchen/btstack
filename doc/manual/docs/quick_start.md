...
- [MinGW64](https://mingw-w64.org/doku.php) GCC for Windows 64 & 32 bits incl. make. Can be installed with pacman.
- [git](https://git-scm.com) is used to download BTstack source code. Can be installed with pacman.
