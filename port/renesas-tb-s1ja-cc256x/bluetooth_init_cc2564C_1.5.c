...
// - initscripts-TIInit_6.12.26_v1.5.bts
// - AKA TIInit_6.12.26.bts
// - initscripts-TIInit_6.12.26_ble_add-on_v1.5.bts
#include <stdint.h>
...
const uint32_t cc256x_init_script_size = sizeof(cc256x_init_script); // size = 6771 bytes
