...
# remove drivers/timers from makefile
DRIVERS_MAKEFILE=${ZEPHYR_BASE}/drivers/Makefile
sed -i "s|CONFIG_SYS_CLOCK_EXISTS|CONFIG_SYS_CLOCK_EXISTS_DISABLED_BY_BTSTACK|g" ${DRIVERS_MAKEFILE}
